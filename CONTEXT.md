...
│   ├── public/index.html   the dashboard (served at /dashboard) — one file, no build step
│   └── scripts/analyze.mjs analyze any saved run
├── frontend/         the island view (served at /): agents as blobs in three areas
│   ├── index.html
│   └── island3d.js         Three.js island; polls /state
