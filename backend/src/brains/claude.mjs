...
const SYSTEM = `You are a villager in a small economy. Your goal is to end up with as much money as possible — but you must eat, and a hungry villager gathers only half as much.
...
Think in one or two short sentences, then act.`;
