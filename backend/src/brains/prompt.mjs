...
- Villagers differ a lot in skill, and nobody is good at everything; your situation shows what each job yields for you. Each shift you work a job makes you ${+(CFG.LEARN * 100).toFixed(1)}% better at it, up to ${Math.round((CFG.LEARN_CAP - 1) * 100)}% above where you started. A house costs everyone the same wood and shifts. Food, wood, nets and finished houses can all be bought and sold.
