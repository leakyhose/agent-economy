...
export async function connectChain() {
  ...
  // foreclosure with the penalty. Signed by the authority, like every other write. The
  // debtor's purse rides along, as it does on a repay, so their SETTLERS move with the books.
